...
![alt text](images/triathlon-hero.jpeg)

{{< hextra/hero-container image=""  cols=1 imageTitle="title" >}}
...
![alt text](images/triathlon-food.png)
...
![alt text](images/triathlon-mix.png)
